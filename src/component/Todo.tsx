...
export function Todo({ todo }: TodoProps) {
	...
	return (
		<div className="flex gap-2 items-center justify-between p-1 rounded-xl hover:bg-gray-200 hover:text-[#2e026d] hover:font-bold">
			...
			<button
				className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-2 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
